...
const INSTRUMENTS: Array<[CursorMode, string, string]> = [
  ["reader", "reading", "\u27e8 \u27e9"],
  ["finger", "annotate", "\u261d"],
  ["loupe", "evidence", "\u2295"],
  ["quill", "note", "\u270e"],
...
export function Lab({ onClose, cursorMode, setCursorMode }: LabProps) {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <div className="label" style={{ color: "rgba(245,235,210,0.45)" }}>
            lab · marginalia
          </div>
          <h3
            style={{
      ...
      <div
        className="label"
        style={{ color: "rgba(245,235,210,0.45)", marginBottom: 10 }}
      >
        instrument
      </div>
      <div style={{ display: "flex", gap: 4, marginBottom: 28 }}>
        {INSTRUMENTS.map(([m, lab, ico]) => (
          <button
            key={m}
            type="button"
      ...
      <div
        className="label"
        style={{ color: "rgba(245,235,210,0.45)", marginBottom: 12 }}
      >
        your marks
      </div>

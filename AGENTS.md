# AGENTS.md — LLM Book Club “Step-Up” Brief (LLM-Oriented)

This file is written for an LLM agent (Anthropic Codex) to quickly reach a *high-leverage operating understanding* of the LLM Book Club project and to propose/plan upgrades that materially improve grounding, retrieval quality, latency, and production readiness.
...
## 8) Concrete “Codex tasking prompt” (copy/paste to Codex)
...
## 9) Additional “flow” guidance for Codex (how to be maximally useful)
